# jammin + C3 JAM SDK Example

This project was created with [jammin](https://github.com/FluffyLabs/jammin), FluffyLabs' toolbox for JAM service builders.

## What is jammin?

Learn more about jammin in the [official documentation](https://fluffylabs.dev/jammin/). This template uses the **C3 JAM SDK** for building JAM services.
...
├── tests               # jammin tests for your service
└── services/
    └── example/        # Your C3 JAM SDK service
```
